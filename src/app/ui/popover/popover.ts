...
export class NgbPopover implements OnInit, OnDestroy {
  ...
  /**
   * Opens an elementÅfs popover. This is considered a ÅgmanualÅh triggering of the popover.
   */
  open() {
    if (!this._windowRef) {
  ...
  /**
   * Closes an elementÅfs popover. This is considered a ÅgmanualÅh triggering of the popover.
   */
  close(): void {
    if (this._windowRef) {
  ...
  /**
   * Toggles an elementÅfs popover. This is considered a ÅgmanualÅh triggering of the popover.
   */
  toggle(): void {
    if (this._windowRef) {
      this.close();
