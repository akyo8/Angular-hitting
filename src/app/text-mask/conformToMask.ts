...
export default function conformToMask(rawValue = emptyString, mask: Array<RegExp> = emptyArray, config = {}) {
  ...
  const placeholder = config['placeholder'] || convertMaskToPlaceholder(mask, placeholderChar);
