...
export default function createTextMaskInputElement(args: any) {
  let inputElement = args.inputElement;
  let providedMask = args.mask;
  let guide = args.guide;
  let pipe = args.pipe;
  let placeholderChar = args.placeholderChar || defaultPlaceholderChar;
  let onAccept = args.onAccept;
  let onReject = args.onReject;
  let keepCharPositions = args.keepCharPositions || false;
